...
# set PHP7 timezone to Asia/Hong_Kong
sed -i "s/;date.timezone =*/date.timezone = Asia\/Hong_Kong/" /etc/php/7.0/fpm/php.ini
sed -i "s/;date.timezone =*/date.timezone = Asia\/Hong_Kong/" /etc/php/7.0/cli/php.ini
